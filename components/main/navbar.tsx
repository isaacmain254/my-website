...
export const Navbar = () => {
  ...
  return (
    <header
      role="banner"
      className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001427] backdrop-blur-md z-50 px-2 lg:px-10"
    >
      <nav
      ...
      >
        ...
        >
          ...
          />
          <div className="font-bold text-gray-300">Isaac Maina</div>
        </Link>
        ...
        {mobileMenuOpen && (
          <div className="flex flex-col w-full absolute z-50 top-14 right-0 left-0 py-4 px-2 bg-[#1e1e1e] text-white  leading-9 ">
            ...
            <Link
              ...
              className="hidden gap-2 cursor-pointer border-b border-gray-400 py-2 hover:text-[rgb(112,66,248)] transition"
              onClick={() => setMobileMenuOpen(false)}
            >
              Upwork
            </Link>
        ...
        <div className="hidden flex-row gap-3">
          <Link
            href="https://www.upwork.com/freelancers/~01466943c42b35dcd4"
            target="_blank"
            rel="noreferrer noopener"
